...
const actionGetHumanitiesLevelTestAgent = 'action_get_humanities_level_test_agent';
const baseKeynodes = [
    { id: question, type: ScType.NodeConstClass },
    { id: actionGetHumanitiesLevelTestAgent, type: ScType.NodeConstClass },
];
...
const describeAgent = async (keynodes: Record<string, ScAddr>) => {
    ...
    template.triple(keynodes[actionGetHumanitiesLevelTestAgent], ScType.EdgeAccessVarPosPerm, actionNodeAlias);
...
export const getHumanitiesLevelTestAgent = async () => {
