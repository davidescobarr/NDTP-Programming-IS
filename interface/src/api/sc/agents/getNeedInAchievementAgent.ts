...
const actionGetNeedInAchievementTestAgent = 'action_get_need_in_achievement_test_agent';
const baseKeynodes = [
    { id: question, type: ScType.NodeConstClass },
    { id: actionGetNeedInAchievementTestAgent, type: ScType.NodeConstClass },
];
...
const describeAgent = async (keynodes: Record<string, ScAddr>) => {
    ...
    template.triple(keynodes[actionGetNeedInAchievementTestAgent], ScType.EdgeAccessVarPosPerm, actionNodeAlias);
...
export const getNeedInAchievementTestAgent = async () => {
