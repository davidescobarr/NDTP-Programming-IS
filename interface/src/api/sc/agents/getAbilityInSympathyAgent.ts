...
const actionGetAbilityInSympathyTestAgent = 'action_get_ability_in_sympathy_test_agent';
const baseKeynodes = [
    { id: question, type: ScType.NodeConstClass },
    { id: actionGetAbilityInSympathyTestAgent, type: ScType.NodeConstClass },
];
...
const describeAgent = async (keynodes: Record<string, ScAddr>) => {
    ...
    template.triple(keynodes[actionGetAbilityInSympathyTestAgent], ScType.EdgeAccessVarPosPerm, actionNodeAlias);
...
export const getAbilityInSympathyTestAgent = async () => {
