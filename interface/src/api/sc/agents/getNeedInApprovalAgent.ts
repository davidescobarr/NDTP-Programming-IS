...
const actionGetNeedInApprovalTestAgent = 'action_get_need_in_approval_test_agent';
const baseKeynodes = [
    { id: question, type: ScType.NodeConstClass },
    { id: actionGetNeedInApprovalTestAgent, type: ScType.NodeConstClass },
];
...
const describeAgent = async (keynodes: Record<string, ScAddr>) => {
    ...
    template.triple(keynodes[actionGetNeedInApprovalTestAgent], ScType.EdgeAccessVarPosPerm, actionNodeAlias);
...
export const getNeedInApprovalTestAgent = async () => {
