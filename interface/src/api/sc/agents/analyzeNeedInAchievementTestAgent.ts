...
const actionAnalyzeNeedInAchievementTestAgent = 'action_analyze_need_in_achievement_test_agent';
const rrel1 = 'rrel_1';

const baseKeynodes = [
  { id: question, type: ScType.NodeConstClass },
  { id: actionAnalyzeNeedInAchievementTestAgent, type: ScType.NodeConstClass },
...
const describeAgent = async (
  ...
  template.triple(
      keynodes[actionAnalyzeNeedInAchievementTestAgent],
      ScType.EdgeAccessVarPosPerm,
      actionNodeAlias
  );
...
export const analyzeNeedInAchievementTestAgent = async (userAnswers: object) => {
