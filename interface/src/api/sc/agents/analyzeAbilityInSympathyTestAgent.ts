...
const actionAnalyzeAbilityInSympathyTestAgent = 'action_analyze_ability_in_sympathy_test_agent';
const rrel1 = 'rrel_1';

const baseKeynodes = [
  { id: question, type: ScType.NodeConstClass },
  { id: actionAnalyzeAbilityInSympathyTestAgent, type: ScType.NodeConstClass },
...
const describeAgent = async (
  ...
  template.triple(
      keynodes[actionAnalyzeAbilityInSympathyTestAgent],
      ScType.EdgeAccessVarPosPerm,
      actionNodeAlias
  );
...
export const analyzeAbilityInSympathyTestAgent = async (userAnswers: object) => {
